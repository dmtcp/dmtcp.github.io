...
### Do I need to re-compile or re-link my applications to use DMTCP?


No. DMTCP is completely transparent in this sense.

### Do I need to add kernel modules or patch my kernel?
...
##  Architectures Supported by DMTCP


### What CPUs has DMTCP been ported to?
...
### What operating systems has DMTCP been ported to?
...
### What types of networks does DMTCP support?
...
### What Linux distributions do you test on?
...
### Can I enable tracing of DMTCP internals?
...
### What is the run-time overhead of DMTCP?
...
### What O/S features are supported by DMTCP?
...
## About the DMTCP Project


### Who should I write to for support?
...
### When was work on DMTCP begun, and who works on it now?
...
### How should I cite DMTCP in a publication?
...
## What Applications does DMTCP Support?
...
### Does DMTCP support checkpointing of Matlab?


Yes. Please [see below](FAQ.html#matlab).

### Does DMTCP support checkpointing of [R
...
release####2.4, DMTCP fully supports OpenMP and Cilk.
...
### Does DMTCP support checkpointing of Matlab programs?
